...
const FoodBankI18n = (() => {
  ...
  const UI = {
    en: {
      ...
      community_needs_subtitle: "Help fill what clients requested this trip. No login required.",
      community_pickup: "Pickup",
      community_not_recorded: "Capacity has not been set yet. Check back after staff updates the donor board.",
      community_unpublished: "The community board is being prepared. Check back soon.",
      community_title: "This trip's remaining needs",
      community_subtitle: "Help fill what clients requested this trip. No account needed.",
      community_not_ready: "Capacity has not been set yet. Check back after staff updates the donor board.",

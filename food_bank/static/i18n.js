...
const FoodBankI18n = (() => {
  ...
  const UI = {
    en: {
      ...
      forecast_disclaimer: "Estimate only — not a guarantee.",
      lang_label: "Language",
      shop_title: "Shop",
    ...
    es: {
      ...
      forecast_disclaimer: "Solo una estimación, no una garantía.",
      lang_label: "Idioma",
      shop_title: "Tienda",
    ...
    zh: {
      ...
      request_expecting_visit: "您本周预计会来领取食物吗？",
      request_expecting_yes: "是的，我预计会来",
      request_expecting_no: "不，本周不来",
      request_expecting_hint: "这有助于我们估算计划来访家庭的需求。您的回答是匿名的。",
      about_mission_title: "我们的使命",
      about_hours_title: "开放时间",
      about_location_title: "地点",
      about_help_title: "如何帮助",
      about_help_body: "分享您家庭的需求，或在社区捐赠板上承诺捐赠开放类别。",
      forecast_disclaimer: "仅为估算，不保证实际结果。",
      lang_label: "语言",
      shop_title: "选购",
    ...
    vi: {
      ...
      request_expecting_visit: "Bạn có dự kiến đến nhận thực phẩm tuần này không?",
      request_expecting_yes: "Có, tôi dự kiến sẽ đến",
      request_expecting_no: "Không, tuần này không",
      request_expecting_hint: "Điều này giúp chúng tôi ước tính nhu cầu từ các hộ dự kiến đến thăm. Câu trả lời của bạn là ẩn danh.",
      about_mission_title: "Sứ mệnh",
      about_hours_title: "Giờ mở cửa",
      about_location_title: "Địa điểm",
      about_help_title: "Cách giúp đỡ",
      about_help_body: "Chia sẻ nhu cầu hộ gia đình của bạn hoặc cam kết quyên góp trên bảng khu phố.",
      forecast_disclaimer: "Chỉ là ước tính, không phải cam kết.",
      lang_label: "Ngôn ngữ",
      shop_title: "Mua sắm",
    ...
    tl: {
      ...
      request_expecting_visit: "Inaasahan mo bang bumisita para sa pagkain ngayong linggo?",
      request_expecting_yes: "Oo, inaasahan kong bumisita",
      request_expecting_no: "Hindi, hindi ngayong linggo",
      request_expecting_hint: "Tumutulong ito sa pagtatantya ng demand mula sa mga pamilyang planong bumisita. Anonymous ang sagot mo.",
      about_mission_title: "Aming misyon",
      about_hours_title: "Oras",
      about_location_title: "Lokasyon",
      about_help_title: "Paano tumulong",
      about_help_body: "Ibahagi ang kailangan ng inyong sambahayan, o mag-pledge sa neighborhood board.",
      forecast_disclaimer: "Tantiya lamang, hindi garantiya.",
      lang_label: "Wika",
      shop_title: "Mamili",
    ...
    so: {
      ...
      request_expecting_visit: "Ma filaysaa inaad booqato cunto toddobaadkan?",
      request_expecting_yes: "Haa, waxaan filayaa inaan booqdo",
      request_expecting_no: "Maya, ma ahan toddobaadkan",
      request_expecting_hint: "Tani waxay naga caawisaa inaan qiyaasno baahida qoysaska booqashada filaya. Jawaabtaadu waa qarsoodi.",
      about_mission_title: "Hadafkayaga",
      about_hours_title: "Saacadaha",
      about_location_title: "Goobta",
      about_help_title: "Sida loo caawiyo",
      about_help_body: "La wadaag baahida gurigaaga, ama ballanqaad ku bixi guddiga xaafadda.",
      forecast_disclaimer: "Qiyaas oo keliya, ma aha dammaanad.",
      lang_label: "Luqadda",
      shop_title: "Iibso",
